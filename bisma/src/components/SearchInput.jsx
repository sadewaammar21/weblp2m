...
const SearchInput = ({ label, placeholder, value, onChange, onSearch, width = 'w-1/2', color }) => { // Default width is half-page
  return (
    <div className={`flex flex-col space-y-2 ${width}`}>
      ...
      <div className="flex items-center border border-gray-400 rounded-lg overflow-hidden">
        ...
        <button 
          onClick={onSearch} 
          className={`${color} p-3 flex items-center justify-center text-white`}
        >
          <FaSearch />
        </button>
      </div>
