  ...
  useEffect(() => {
    if (isOpen) {
      if (initialData) {
        ...
        setNidn(initialData.nidn || "");
        setData({
          cluster_lv1: initialData.cluster_lv1 || null,
          cluster_lv2: initialData.cluster_lv2 || null,
          cluster_lv3: initialData.cluster_lv3 || null,
        });

        if (initialData.cluster_lv1) {
          fetchCluster2(initialData.cluster_lv1);
        }
        if (initialData.cluster_lv2) {
          fetchCluster3(initialData.cluster_lv2);
        }
      } else {
  ...
  return (
    ...
    >
      <h1 className="text-xl font-bold mx-2 my-4">
        {initialData ? "Edit Anggota Pengabdian" : "Tambah Anggota Pengabdian"}
      </h1>
      ...
      <div className="p-4">
        ...
        <TextfieldCmp
          label="Perusahaan"
          value={memberData.pivot?.partner || ""}
          name="pivot.partner"
          onChange={handleInputChange}
          placeholder="Nama PT"
        />
