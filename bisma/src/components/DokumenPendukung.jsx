  ...
  return (
    <div>
      ...
      <div>
          ...
          <PopUpDokumenPendukung isOpen={isModalOpen} onRequestClose={closeModal} index={data['supportingDocument'].length} onSave={handleAddDocument}/>
          ...
          <table className="w-full text-sm text-center bg-neutral-20 text-gray-500 dark:text-gray-400 border border-gray-300 ">
            <thead className="border border-gray-300 text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
              <tr className="border border-black">
                ...
                <th className="border border-black px-4 py-2">Kontribusi Pendanaan</th>
            ...
            <tbody>
              {data.supportingDocument.map((item, index) => (
                <tr key={index}>
                  ...
                  <td>Tahun 1: {item.funding_contribution1} <br /> Tahun 2: {item.funding_contribution2}</td>
                  <td>some action</td>
                </tr>
              ))}
            </tbody>
