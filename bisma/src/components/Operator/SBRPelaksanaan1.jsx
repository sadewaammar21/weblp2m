        ...
        <div className="bg-white max-w-6xl mx-auto shadow-md rounded-md">
          ...
          <div className="flex mx-5">
            <button
              ...
              className="flex items-center px-2 py-1 bg-green-500 text-white rounded-md hover:bg-green-600 mx-2 my-2"
            >
              <img
            ...
            <button
              onClick={handlePlus}
              className="flex items-center px-2 py-1 bg-blue-500 text-white rounded-md hover:bg-green-600 mx-2 my-2"
            >
