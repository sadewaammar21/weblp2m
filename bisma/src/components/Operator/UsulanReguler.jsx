...
const UsulanReguler = () => {
    ...
    const metrics = [
        { title: 'Usulan Draft', count: "Rapek", icon: <FaFileAlt size={24} className="text-violet-800" />, path: "/monitoring-usulan-reguler-usulan-draft" },
        { title: 'Usulan Dikirim', count: 0, icon: <FaRegBookmark size={24} className="text-violet-800" />, path: "/monitoring-usulan-reguler-usulan-dikirm" },
        { title: 'Usulan Belum Ditinjau', count: 0, icon: <FaHdd size={24} className="text-violet-800" />, path: "/monitoring-usulan-reguler-belum-ditinjau-review" },
        { title: 'Usulan Disetujui', count: 0, icon: <FaBullseye size={24} className="text-violet-800" />, path: "/monitoring-usulan-reguler-usulan-disetujui" },
        { title: 'Usulan Ditolak', count: 0, icon: <FaChartBar size={24} className="text-violet-800" />, path: "/monitoring-usulan-reguler-usulan-ditolak" },
        { title: 'Hasil Review', count: 0, icon: <FaRecycle size={24} className="text-violet-800" />, path: "/monitoring-usulan-reguler-hasil-review" },
      ];
