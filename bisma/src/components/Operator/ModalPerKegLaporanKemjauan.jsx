...
const ModalPerKegLaporanKemajuan = ({ researchId, isOpen, onRequestClose }) => {
  ...
  const handleSubmit = async() => {
    const response = await setResearchProgressReportDeadline({researchId, data:{progress_report_deadline:startDate}})
      ...
      <div className="bg-white shadow-md rounded-md p-6 w-full max-w-2xl">
        ...
        <div className="flex justify-between items-center border-b pb-2 mb-4">
          <h2 className="text-lg font-bold">
            Deadline Laporan Kemajuan - Ubah
          </h2>
          <button
...
export default ModalPerKegLaporanKemajuan;
