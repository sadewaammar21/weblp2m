...
import { FaArrowLeft, FaPlus, FaCcMastercard, FaTrash} from 'react-icons/fa';
...
//   };
  ...
  return (
    <div className="min-h-screen p-5 mx-10 my-5">
      <h1 className="text-xl font-bold text-violet-800 mb-4">Penugasan Review</h1>
      <h1 className="text-sm font-sans mb-4">Seleberan Beban Review-Pelaksanaan</h1>
...
export default SBRPelaksanaan2;
