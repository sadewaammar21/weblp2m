...
const PenelitianProposalTab2 = () => {
  ...
  <tbody>
    ...
    <tr>
      ...
      <td rowSpan="3" className="border border-gray-400 px-4 py-2 text-center" colSpan={4}>
    ...
    <tr>
      ...
      <td rowSpan="4" className="border border-gray-400 px-4 py-2 text-center" colSpan={4}>
        <div className="grid grid-cols-4 gap-2">
    ...
    <tr>
      ...
      <td rowSpan="2" className="border border-gray-400 px-4 py-2 text-center" colSpan={4}>
        <div className="grid grid-cols-4 gap-2">
