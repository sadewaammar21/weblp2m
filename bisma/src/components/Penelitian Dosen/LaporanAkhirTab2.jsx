...
import ModalSPTBLaporanAkhir from "./ModalSPTBLaporanAkhir";

const LaporanAkhirTab2 = ({ research, data, setData }) => {
  ...
  return (
    <div>
      ...
      <ModalSPTBLaporanAkhir research={research} data={data} isOpen={isOpen} onRequestClose={closeModal} onSave={handelSptbData} />
      <div className="my-5">
